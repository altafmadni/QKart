...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "Register user", "Starting Testcase 01");
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Register user: TC01", "Registration Failed");
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Register user: TC01", "Login Failed");
            return false;
        }
        ...
        takeScreenshot(driver, "TC-01", "Ending Testcase");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        // Visit the Registration page and register a new user
        takeScreenshot(driver, "Register user", "Starting Testcase 02");
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        ...
        logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                status ? "FAIL" : "PASS");
        takeScreenshot(driver, "TC-02", "Ending Testcase");
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "TC-03", "Starting Testcase 03");
            ...
            if (!elementText.toUpperCase().contains("YONEX")) {
                logStatus("TestCase 3",
                        "Test Case Failure. Test Results contains un-expected values: "
                                + elementText,
                        "FAIL");
                takeScreenshot(driver, "Test Case-3 Failure.",
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "Product searching Failure.",
                    "Unable to search for given product");
            return false;
        }
        ...
        if (searchResults.size() == 0) {
            ...
            logStatus("TestCase 3",
                    ...
                    "FAIL");
            takeScreenshot(driver, "getSearchResult", "Product found.");
            return false;
        }

        takeScreenshot(driver, "TC-03", "Ending Testcase");
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "TC-04", "Starting Testcase 04");
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                if (result.openSizechart()) {
                    ...
                    takeScreenshot(driver, "TC-04", "Failure to open Size Chart");
                ...
                takeScreenshot(driver, "TC-04", "Size Chart Link does not exist");
                return false;
            }
        }
        logStatus("TestCase 4", "Test Case PASS. Validated Size Chart Details", "PASS");

        takeScreenshot(driver, "TC-04", "Ending Testcase");
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "TC-05", "Starting Testcase 05");
        Boolean status;
        ...
        logStatus("End TestCase", "Test Case 5: Happy Flow Test Completed : ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "TC-05", "Ending Testcase");
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "TC-06", "Starting Testcase 06");
        ...
        logStatus("End TestCase", "Test Case 6: Verify that cart can be edited: ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "TC-06", "Ending Testcase 06");
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "TC-07", "Starting Testcase 07");
        ...
        logStatus("End TestCase",
                "Test Case 7: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "TC-07", "Ending Testcase 07");
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        takeScreenshot(driver, "TC-08", "Starting Testcase 08");
        logStatus("Start TestCase", "Test Case 8: Verify the content of the cart.", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 8: Verify the content of the cart. ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-08", "User Registration");
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 8: Verify the content of the cart.",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-08", "User Login");
        ...
        driver.switchTo().window(windows.toArray(new String[windows.size()])[0]);
        takeScreenshot(driver, "TC-08", "Ending Testcase 08");
        logStatus("End TestCase",
        "Test Case 8: Verify the content of the cart. ",
        status ? "PASS" : "FAIL");
        return status;
    }
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        Boolean status = false;
        takeScreenshot(driver, "TC-09", "Starting Testcase 09");
        logStatus("Start TestCase",
                "Test Case 9: Verify the Privacy policy, About us are displayed correctly", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 9: Verify the Privacy policy, About us are displayed correctly ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-09", "User Registration");
        ...
        if (!status) {
            ...
            logStatus("End TestCase",
                    "Test Case 9: Verify the Privacy policy, About us are displayed correctly",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-09", "User Login");
        ...
        driver.findElement(By.linkText("Privacy policy")).click();
        if (!basePageURl.equals(driver.getCurrentUrl())) {
            return false;
        }
        ...
        System.out.println("Privacy policy : " + privacyPolicyHeading.getText());
        ...
        driver.switchTo().window(windows.toArray(new String[windows.size()])[2]);
        ...
        takeScreenshot(driver, "TC-09", "Ending Testcase 09");
        driver.close();

        driver.switchTo().window(windows.toArray(new String[windows.size()])[1]).close();
        driver.switchTo().window(windows.toArray(new String[windows.size()])[0]);
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        takeScreenshot(driver, "TC-10", "Starting Testcase 10");
        logStatus("Start TestCase",
                "Test Case 10: Verify contact us dialog box.", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 10: Verify contact us dialog box.",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-10", "User Registration");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 10: Verify the contact us dialog box",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "TC-10", "User Login");
        ...
        takeScreenshot(driver, "TC-10", "Ending Testcase 10");
        logStatus("End TestCase",
        "Test Case 10: Verify the contact us dialog box.",
        status ? "PASS" : "FAIL");
        return status;
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        takeScreenshot(driver, "TC-11", "Starting Testcase 11");
        logStatus("Start TestCase", "Test Case 11: Verify advertisement is clickable.", "DONE");
        ...
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
          ...
          status = registration.registerUser("testUser", "abc@123", true);
          if (!status) {
              logStatus("TestCase 11", "Test Case 11: Verify advertisement is clickable.", "FAIL");
          }
          ...
          if (!status) {
              logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
              logStatus("End TestCase", "Test Case 11: Verify advertisement is clickable : ",
                      status ? "PASS" : "FAIL");
          }
          ...
          String currentURL = driver.getCurrentUrl();
          List<WebElement> advertisement = driver.findElements(By.xpath("//ifrmaes"));
          
          status = advertisement.size() == 3;

          WebElement adv1 = driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div/iframe[1]"));
          ...
          logStatus("Test Step", "Verify advertisement 1 is clickable.", status ? "PASS" : "FAIL");

          Thread.sleep(3000);


          WebElement adv2 = driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div/iframe[2]"));
          ...
          logStatus("Test Step", "Verify advertisement 2 is clickable.", status ? "PASS" : "FAIL");
          Thread.sleep(3000);
        takeScreenshot(driver, "TC-11", "Ending Testcase 11");
        logStatus("End TestCase",
        "Test Case 11: Verify advertisement is clickable :",
        status ? "PASS" : "FAIL");
