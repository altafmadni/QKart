    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
            ...
            for (int i = 0; i < expectedTableHeaders.size(); i++) {
                ...
                System.out.println("expectedTableHeaders = " + expectedTableHeaders.get(i));
                System.out.println("tempHeaderValue = " + tempHeaderValue);
            ...
            for (int i = 0; i < expectedTableBody.size(); i++) {
                ...
                for (int j = 0; j < expectedTableBody.get(i).size(); j++) {
                    ...
                    System.out.println("tempHeaderValue = " + tempHeaderValue);
                    System.out.println("expectedTableBody.get(i).get(j) = " + expectedTableBody.get(i).get(j));
